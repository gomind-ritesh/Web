...
<head>
    ...
    <title>Add Edit Food Menu | Red Lantern</title>
...
?>
    <div class="food-container">
        <div class="food-form">
            ...
            <p>This food item is linked to a bill. Availability will be set to 0 once you add a new food. Right now, you are adding a new food since the previous food can't be edited due to lost of analytics</p>
